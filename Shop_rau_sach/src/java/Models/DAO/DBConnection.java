...
public class DBConnection {
    ...
    public DBConnection() {
        try {
            ...
            conn = (Connection) DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/kvt?useUnicode=true&characterEncoding=UTF-8", "root", "123456"); //Connects to MySQL Server base on URL, UID, PWD
