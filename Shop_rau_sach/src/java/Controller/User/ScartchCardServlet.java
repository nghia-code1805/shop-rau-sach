        ...
        switch (charge) { //the value of cards is 50000,100000, 200000, 500000
            ...
            case 500000:
                ...
                if (count > 0) { //if card available right now 
                    ...
                    //-------------- Send mail ------------------
                    String message = "Thanks for Charging from Shop_rau_sach Shop ^_^ <br/>"
                            + "your cardNumber is : " + cartNumber + "<br/> with value of : " + charge + "VND"
                            + "<br/> to charge your cart <a href='http://localhost:8080/Shop_rau_sach/ConfirmScratchCard.jsp'> click here </a>";
