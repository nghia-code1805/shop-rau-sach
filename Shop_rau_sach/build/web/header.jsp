                        ...
                        <div class="col-sm-6">
                            <div class="contactinfo">
                                <ul class="nav nav-pills">
                                    <li><a href="#"><i class="fa fa-phone"></i> +84 384 657 1597</a></li>
                                    <li><a href="#"><i class="fa fa-envelope"></i>nguyenmo6497@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="social-icons pull-right">
                                <ul class="nav navbar-nav">
                                    <li><a href="https://www.facebook.com/profile.php?id=100011525954419"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/Shop Mo"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="https://www.facebook.com/profile.php?id=100011525954419/"><i class="fa fa-instagram"></i></a></li>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="logo pull-left">
                                <a href="index.jsp"><img src="images/home/logo2.jpg" alt="" /></a>
                            </div>
